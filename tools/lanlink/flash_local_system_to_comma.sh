#!/usr/bin/env bash
# 烧写本地构建的 sunnypilot system 镜像（19.7.1，含蓝牙 overlay）到设备的 inactive slot。
#
...
SYSTEM_IMAGE="${2:-$HOME/Documents/Projects/agnos-builder/output/system-19.7.1.img.xz}"
EXPECTED_VERSION="${EXPECTED_VERSION:-19.7.1}"
