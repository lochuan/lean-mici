...
DEVICE_TREE="ssh://$DEVICE/data/openpilot"
...
git push "$DEVICE_TREE" lean-master:refs/remotes/origin/lean-master 2>&1 | tail -1
...
git push "$DEVICE_TREE" refs/temp/device-release:refs/remotes/origin/lean-release 2>&1 | tail -1
