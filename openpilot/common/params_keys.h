...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"CruiseButtonsEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"CruiseButtonsAccel", {PERSISTENT, FLOAT}},
    {"CruiseButtonsCurve", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"CruiseButtonsLead", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"CruiseButtonsStandstill", {PERSISTENT | BACKUP, BOOL, "1"}},
    ...
    {"Offroad_ModelUnavailable", {CLEAR_ON_MANAGER_START, JSON}},
    ...
    {"ToyotaEnforceStockLongitudinal", {PERSISTENT | BACKUP, BOOL, "1"}},
